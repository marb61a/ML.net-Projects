...
namespace DecisionTreesRegression.MachineLearning.Predictors
{
    public class Predictor
    {
        ...
        {
            LoadModel();
            var predictionEngine = _mlContext.Model.CreatePredictionEngine<BostonHousingData, BostonHousingPricePredictions>(_model);
